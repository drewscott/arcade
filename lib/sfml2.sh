...
readonly SFML_DEB_URL="file://$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/../deb/libsfml_2.5.1_amd64.deb"
readonly SFML_DEV_DEB_URL="file://$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/../deb/libsfml-dev_2.5.1_amd64.deb"

readonly SFML_SRC_URL="https://www.sfml-dev.org/files/SFML-2.5.1-sources.zip"
